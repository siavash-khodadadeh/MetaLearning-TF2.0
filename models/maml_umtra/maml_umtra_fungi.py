...
if __name__ == '__main__':
    ...
    maml_umtra.evaluate(50, num_tasks=1000, seed=42, use_val_batch_statistics=False)
    maml_umtra.evaluate(50, num_tasks=1000, seed=42, use_val_batch_statistics=True)
