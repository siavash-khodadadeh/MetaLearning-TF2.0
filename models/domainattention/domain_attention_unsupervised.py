...
class DomainAttentionUnsupervised(CombinedCrossDomainMetaLearning):
    ...
    def get_only_outer_loop_update_layers(self):
        ...
        for layer_name in (
            'conv1', 'conv2', 'conv3', 'conv4', 'bn1', 'bn2', 'bn3', 'bn4', 'channel_attention_0',
            'channel_attention_1', 'channel_attention_2', 'channel_attention_3'
        ):
...
def run_domain_attention():
    ...
    da = DomainAttentionUnsupervised(
        ...
        num_tasks_val=100,
        clip_gradients=True,
        experiment_name='domain_attention_freeze_attention_instance_unsupervised',
        val_seed=42,
